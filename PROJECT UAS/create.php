...
<div class="container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            <label>Kelas :</label>
            <label><input type="radio" name="kelas" value="MI-1A" required> MI-1A</label>
            <label><input type="radio" name="kelas" value="MI-1B" required> MI-1B</label>
            <label><input type="radio" name="kelas" value="MI-1C" required> MI-1C</label>
            <label><input type="radio" name="kelas" value="MI-1D" required> MI-1D</label>
            <label><input type="radio" name="kelas" value="MI-1E" required> MI-1E</label>
        </div>
        <div class="form-group">
